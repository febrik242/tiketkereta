        ...
        <div id="content-wrapper" class="d-flex flex-column">
			...
			<div class="card-body">
				...
				if (isset($_POST['submit'])) {
					...
					mysqli_query($conn, "update barang set nama='$nama', harga='$harga', deskripsi='$deskripsi' where id ='$id'") or die(mysqli_error($conn));

					//redirect ke halaman index.php
					echo "<script>alert('data berhasil diupdate.');window.location='awal.php';</script>";
				}
