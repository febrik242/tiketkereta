...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Content Row -->
                        ...
                        <form method="POST" action="tamabahdatapemesan.php" enctype="multipart/form-data">
  <div class="card-body">
  ...
  <a type="button" class="btn btn-danger float-right" href="dashboard.php">Halaman Utama</a>
  <a type="button" class="btn btn-primary" href="pemesanan.php">Kembali</a>
</form>
</div>
        <!-- Content Row -->
